...
$active_term = (isset($qo->taxonomy) && $qo->taxonomy === 'category') ? $qo : null;
$active_term_slug = $active_term ? (string) $active_term->slug : '';

$archive_title = $active_term ? $active_term->name : __('News', 'ace-theme');
