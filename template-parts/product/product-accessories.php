...
$hide = carbon_get_the_post_meta('accessories_hide_section');
if ($hide === null || $hide === '') { $hide = carbon_get_the_post_meta('hide_section'); }
if ($hide) { return; }

$full = carbon_get_the_post_meta('accessories_full_width');
if ($full === null || $full === '') { $full = carbon_get_the_post_meta('accessories_full_width'); }
